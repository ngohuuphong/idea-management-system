    ...
    <div class="tab-content ai-wrap">
      <ul class="chat">
        <li class="your-message">
          <p>
            デジタル技術の導入と運用コストについて、課題を3つ簡潔に要点をおさせて教えて
          </p>
        </li>
        <li class="ai-message">
        ...
        <li class="ai-message">
          <img class="icon" src="{{ asset('images/ico-ai.png') }}" alt="AIアイコン">
          <p>
            どういたしまして！他に何かお手伝いできることがあれば、いつでもお知らせください。
          </p>
        </li>
      </ul>
...
<div id="remand" class="modal js-modal reason-modal">
  ...
  <div class="modal_content">
    <a class="js-modal-close close-btn" href=""><img src="../images/modal-close.svg" alt="閉じる"></a>
    <form>
      <label>このアイデアを差戻しする理由</label>
      <textarea placeholder="差戻し理由を入力"></textarea>
...
<div id="approval" class="modal js-modal reason-modal">
  ...
  <div class="modal_content">
    ...
    <form>
      ...
      <textarea placeholder="承認理由を入力"></textarea>
